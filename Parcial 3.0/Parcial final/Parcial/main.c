...
int main()
{
    ...
    do
    {
        ...
        switch(toupper(opcion))
        {
            ...
            case 5:
                    //informar_masMusicos(arrayMusico,QTY_TIPO,arrayOrquesta,QTY_TIPO,arrayInstrumento,QTY_TIPO);
                    //(LISTO)informar_OrquestaXmusicos(arrayMusico,QTY_TIPO,arrayOrquesta,QTY_TIPO,arrayInstrumento,QTY_TIPO);
                    //(LISTO)ListarxLugar(arrayOrquesta,QTY_TIPO);
                    //(LISTO)listarXorquesta(arrayMusico,QTY_TIPO,arrayOrquesta,QTY_TIPO,arrayInstrumento,QTY_TIPO);
